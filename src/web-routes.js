...
export const webRoutes = [
    ...
    { method: "GET", path: "/api/generateweather", config: weatherController.generateWeatherReport },
    { method: "GET", path: "/api/{id}/generateweather/{lighthouseid}", config: weatherController.indexAPI },
